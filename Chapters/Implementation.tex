...
\begin{figure}[H]
  ...
  \end{subfigure}
  \caption{The Directory Value plugin adds data at the position \code{preset} (\ref{fig:keyset_large}) and then restores the old data (\ref{fig:keyset_large_extended}) at the position \code{postget}.}
\end{figure}
