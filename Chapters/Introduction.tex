...
\begin{description}[style=multiline, leftmargin=3.2cm, font=\bfseries]
  ...
  \item[Implementation] We wrote parsing code that handles our minimal YAML subset. In this phase we also added other necessary support code to Elektra.
