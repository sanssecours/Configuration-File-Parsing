...
The goal of this evaluation is to find a parser plugin that
\begin{itemize}
  \item is fast,
  \item has low resource usage,
  \item uses code that is
    \begin{itemize}
...
\begin{itemize}
  \item the runtime performance benchmark, described in “\nameref{sec:run_time_performance}”, and
  \item the heap memory usage comparison, described in “\nameref{sec:memory_usage}”
\end{itemize}
