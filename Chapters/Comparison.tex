...
Since both of these files are relatively small,\href{https://github.com/ElektraInitiative/rawdata/tree/master/YAML/keyframes.yaml}{\code{keyframes.yaml}} contains 219 lines, while \href{https://github.com/ElektraInitiative/rawdata/tree/master/YAML/combined.yaml}{\code{combined.yaml}} contains 153 lines, we also generate data using a Python script that we called \href{https://master.libelektra.org/scripts/generate-yaml}{\code{generate-yaml}}. This script generates YAML maps using \href{https://en.wikipedia.org/wiki/Universally_unique_identifier}{\glspl{UUID}} as scalar keys and values. For the YAML scalars the script randomly selects one of the three flow scalar styles:
...
. This always works since \glspl{UUID} contain no character sequence that has special meaning according to the YAML specification.

\subsection{Results}

The graphs in this section show the results of the benchmark for different input files. The data file \href{https://github.com/ElektraInitiative/rawdata/tree/master/YAML/generated.yaml}{\code{generated.yaml}} was generated from the script \href{https://master.libelektra.org/scripts/generate-yaml}{\code{generate-yaml}} and contains 10 000 YAML scalars.
