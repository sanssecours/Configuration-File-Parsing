...
\begin{itemize}[style=multiline, leftmargin=3cm, font=\bfseries]
  ...
  \begin{itemize}
    ...
    \item \href{https://github.com/ElektraInitiative/libelektra/graphs/contributors?from=2012-04-01&to=2019-09-30&type=c}{committed over 3 900 times} to Elektra,
    \item opened \href{https://github.com/ElektraInitiative/libelektra/pulls?&q=is:merged+is:pr+author:sanssecours+}{over 360 merged pull requests}, and
