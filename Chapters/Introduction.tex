...
\begin{description}[style=multiline, leftmargin=3.2cm, font=\bfseries]
  ...
  \begin{description}
    \item[Benchmark] For the speed comparison we use benchmarks to determine the speed of the different YAML plugins. In this part of the thesis, we will answer \Cref{que:speed}.
  \end{description}
