...
In the first part of the thesis we look at the current state of parsing according to the literature. After that we provide a short overview of Elektra, the key-value storage framework we use in the thesis. At the end of this chapter we provide some examples about other research papers that evaluate parsers and parser engines.
