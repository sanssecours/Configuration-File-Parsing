...
\begin{listing}
  \begin{code-boxed}
    \inputminted{yaml}{Data/Errors/multiple_errors.yaml}
  \end{code-boxed}
  \caption{The YAML data above contains at three syntax errors that we directly describe in the comments right next to the error positions.}
