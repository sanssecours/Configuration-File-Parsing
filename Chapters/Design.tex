...
In the end the decision about the implemented YAML features was largely a results of the implementation phase (see Section~\nameref{sec:parsers}). We built the parser starting with less features such as scalar support and then added additional features. We decided to implement the following list of items for the \glstext{YAML} subset:
