...
\begin{description}[style=multiline, leftmargin=3cm, font=\bfseries]
  \item [Menhir (OCaml)] Menhir is a LR parser generator that provides support for “example based error reporting”~\cite{jeffery2003generating, kaestner2018compcert, pottier2019menhir}. In theory we should be able to generate parsers with Menhir that produce error messages comparable~\cite[p. 2]{kaestner2018compcert} to the ones of handwritten recursive descent parsers, used in tools such as Clang or GCC.
