...
\begin{table}[H]
  ...
  \begin{tabular}{p{3cm}p{2cm}p{2cm}p{2cm}p{2cm}p{2cm}}
    ...
    \multicolumn{6}{l}{Generator/Library Features}\\[0.2cm]
    Name & \href{https://github.com/jbeder/yaml-cpp}{yaml-cpp} & \href{http://antlr.org}{ANTLR} & \href{https://www.gnu.org/software/bison}{Bison} & \href{https://github.com/vnmakarov/yaep}{YAEP} & \href{https://github.com/taocpp/PEGTL}{PEGTL}\\
    Parser Technique & Recursive Descent & \gls{ALL(*)} & \glstext{LALR}(1) & Earley Parser & PEG Parser\\
    Lexer Support & Handwritten & Integrated (Regex) & External & External & Integrated (\glstext{PEG})\\[1cm]

    \midrule
    \multicolumn{6}{l}{Plugin Specific Features}\\[0.2cm]
    Lexer Used & Existing Lexer & Custom C++ Lexer & Custom C++ Lexer & Custom C++ Lexer & Template Based PEG Code\\
