...
For the plugins directly based on a parser, we had to write the least code for Yan LR, followed by YAMBi, YAwn, and YAy PEG. The line count numbers for YAMBi and YAwn are not that surprising, considering that we implemented some functionality already provided by ANTLR, for those plugins ourselves.
