...
Since the initial attempt for our \gls{ANTLR} grammar did not show promising results, we looked at how other \gls{ANTLR} parsers handle significant whitespace.
