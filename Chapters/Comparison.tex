...
\begin{figure}[H]
  ...
  \end{center}
  \caption{The bar chart above shows the run time of the plugins for the YAML input file \href{https://github.com/ElektraInitiative/rawdata/tree/master/YAML/generated.yaml}{\code{generated.yaml}}}
  \label{fig:benchmark}
\end{figure}
