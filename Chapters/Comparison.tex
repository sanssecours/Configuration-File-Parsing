...
\begin{figure}[H]
  ...
  \caption{The diagramm above shows the basic sequence of steps to measure the performance of the YAML plugins.}
  \label{fig:benchmark}
\end{figure}
...
\begin{itemize}
  ...
  \item \href{https://github.com/ElektraInitiative/rawdata/tree/master/YAML/generated.yaml}{\code{generated\_100000.yaml}} that contains 100 000 lines
\end{itemize}
