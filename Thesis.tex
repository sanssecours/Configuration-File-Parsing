...
\newglossaryentry{token}{
    name = token,
    description = {Often parsers do not directly work on the character level. Instead a lexer (a.k.a. scanner or tokenizer) assembles parts of the text into tokens. The parser then uses a stream of tokens as input instead of a stream of characters}
}
