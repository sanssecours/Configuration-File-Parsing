...
\href{https://github.com/ElektraInitiative/rawdata/tree/master/YAML/keyframes.yaml}%
{\code{keyframes.yaml}}%
}}
\newcommand{\FileCombined}{{%
\href{https://github.com/ElektraInitiative/rawdata/tree/master/YAML/combined.yaml}%
{\code{combined.yaml}}%
}}
\newcommand{\FileGenerated}{{%
\href{https://github.com/ElektraInitiative/rawdata/tree/master/YAML/generated.yaml}%
{\code{generated.yaml}}%
}}
\newcommand{\FileGeneratedHundredThousand}{{%
\href{https://github.com/ElektraInitiative/rawdata/tree/master/YAML/generated_100000.yaml}%
...
\href{https://github.com/sanssecours/rawdata/blob/⏱/YAML/Scripts/cut_input}%
{\sh{cut_input}}%
}}
...
. For another input file called \FileCombined{} we copy and pasted data from test data and various other YAML files in Elektra’s repository into a single file. While the file content is nonsensical, it should at least contains a mix of YAML data that covers most of the code paths of the YAML plugins.
