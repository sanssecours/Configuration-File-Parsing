...
\begin{table}[H]
  ...
  \begin{tabular}{p{2.5cm}p{2.2cm}p{2.2cm}p{2.2cm}p{2.2cm}p{2.2cm}}
    ...
    Memory Usage\tnote{M} & 540.7 & 482.2 & 195.6 & 160.4 & 676.6 \\
  ...
  \begin{tablenotes}
    ...
    \item[X] This line shows a overall rating according to the conclusion section of the section about the respective feature.
  \end{tablenotes}
