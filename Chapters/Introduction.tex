...
In this thesis we will look at the configuration file parsing problem and evaluate different options to convert configuration settings. There are many possible ways to parse and store data. Notable examples include:
