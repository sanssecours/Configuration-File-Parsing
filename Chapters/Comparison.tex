...
Adding support for boolean values took $10$ modified code lines for \href{https://issues.libelektra.org/2653}{Yan LR} (\textcolor{Green}{$9$ additions}, \textcolor{Red}{$1$ deletion}), and modified $9$ additions lines (\textcolor{Green}{$8$ additions}, \textcolor{Red}{$1$ deletion}) for the other plugins (\href{https://issues.libelektra.org/2652}{YAMBI}, \href{https://issues.libelektra.org/2651}{YAwn}, \href{https://issues.libelektra.org/2654}{YAy PEG}). The similar line counts are a direct result of all of the plugins using a listener interface to convert parsed YAML data. To add boolean support we only had to change code in one of the functions of the listeners.
...
\midrule
\textcolor{Green}{+} Extension via “Copy \& Paste” &                                 \textcolor{Green}{+}                   Simple Grammar\\
