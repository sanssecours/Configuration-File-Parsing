...
% - Einleitungssätze fehlen
% - Motivation (Warum)
% - Was kommt noch
% - Stärker auf Konfigurationsthema eingehen
% - Kapital: Design Decisions/Challenges \& Choices (Features)

In the first part we describe how we mapped Elektra’s two basic types, \cc{Key} and \cc{KeySet} to \glstext{YAML}.
