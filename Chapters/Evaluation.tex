...
\begin{description}[style=multiline, leftmargin=2cm, font=\bfseries]
  \item[Yan LR] Compared to YAwn, the plugin performed worse in the runtime benchmark. It also requires more memory to parse our example data than YAMBi and YAwn. On the other hand, \gls{ANTLR} provides a lot of support code we had to write for the other plugins ourselves.
