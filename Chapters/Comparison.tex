...
Since both of these files are relatively small,\href{https://github.com/ElektraInitiative/rawdata/tree/master/YAML/keyframes.yaml}{\code{keyframes.yaml}} contains 219 lines, while \href{https://github.com/ElektraInitiative/rawdata/tree/master/YAML/combined.yaml}{\code{combined.yaml}} contains 153 lines, we also generate data using a Python script that we called \href{https://master.libelektra.org/scripts/generate-yaml}{\code{generate-yaml}}.
